        ...
        <div>
            <div className="flex flex-row max-sm:flex-col items-center justify-center max-w-full max-h-full my-4">
                ...
                <div className="p-4 w-1/2 flex items-start justify-center flex-col max-sm:w-full">
                    ...
                    <Link to={`/entry/${entry._id}`} className="block rounded-md bg-[#2ECC40] py-2 px-3 text-sm font-[400] text-white shadow-sm hover:bg-[#259a56] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#2ECC40] mt-4 no-underline">
                        Read More
                    </Link>
